    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('black', 'black'), ('white', 'white'), ('Red', 'red'), ('Green', 'green'), ('Blue', 'blue'), ('Yellow', 'yellow'), ('Purple', 'purple'), ('Orange', 'orange'), ('Pink', 'pink'), ('Teal', 'teal'), ('Gray', 'gray'), ('Brown', 'brown')], help_text='Select a color for the product')),
            ],
            options={
